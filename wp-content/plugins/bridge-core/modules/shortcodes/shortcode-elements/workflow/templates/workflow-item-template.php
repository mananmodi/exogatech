<div class="qode-workflow-item">
    ...
    <div class="qode-workflow-item-inner <?php echo esc_attr($image_on_right_class) ?>">
        ...
        <div class="qode-workflow-text">
            ...
            <?php if(!empty($title)){ ?>
                <<?php echo bridge_qode_get_escape_title_tag($title_tag)?>><?php echo esc_attr($title) ?></<?php echo bridge_qode_get_escape_title_tag($title_tag)?>>
            <?php } ?>
            <?php if(!empty($subtitle)){ ?>
                <<?php echo bridge_qode_get_escape_title_tag($subtitle_tag)?> class="qode-workflow-subtitle"><?php echo esc_attr($subtitle) ?></<?php echo bridge_qode_get_escape_title_tag($subtitle_tag)?>>
            <?php } ?>
            <?php if(!empty($text)){ ?>
