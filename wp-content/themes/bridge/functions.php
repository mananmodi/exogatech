...
if ( ! function_exists( 'create_trainer_post_type' ) ) {
	...
	function create_trainer_post_type() {
		$labels = array(
			'name'                => _x( 'Trainers', 'Post Type General Name', 'twentytwenty' ),
			'singular_name'       => _x( 'Trainers', 'Post Type Singular Name', 'twentytwenty' ),
			'menu_name'           => __( 'Trainers', 'twentytwenty' ),
			'parent_item_colon'   => __( 'Parent Trainer', 'twentytwenty' ),
			'all_items'           => __( 'All Trainers', 'twentytwenty' ),
			'view_item'           => __( 'View Trainer', 'twentytwenty' ),
			'add_new_item'        => __( 'Add New Trainer', 'twentytwenty' ),
			'add_new'             => __( 'Add Trainer', 'twentytwenty' ),
			'edit_item'           => __( 'Edit Trainer', 'twentytwenty' ),
			'update_item'         => __( 'Update Trainer', 'twentytwenty' ),
			'search_items'        => __( 'Search Trainer', 'twentytwenty' ),
		...
		$args = array(
			'label'               => __( 'Trainers', 'twentytwenty' ),
			'description'         => __( 'Trainers', 'twentytwenty' ),
			'labels'              => $labels,
			'supports'            => array( 'title', 'editor', 'excerpt', 'author', 'thumbnail', 'comments', 'revisions', 'custom-fields' ),
			'menu_icon' => plugin_dir_url( __DIR__ ) . 'assets/images/menu-icon.svg',
			'hierarchical'        => false,
			'public'              => false,
			'show_ui'             => true,
			'show_in_menu'        => true,
